<!-- component -->
<div class="fixed flex items-center justify-between w-60 transition duration-300 transform bg-gray-50 translate-x-0 px-4 py-3 border-gray-600 z-50">
    ...
    <div class="flex justify-between items-center space-x-3">
        ...
        <x-jet-application-logo class="block h-8" />
        <p class="text-xl leading-6 text-dark">iNvoice</p>
    </div>
    ...
    <div aria-label="toggler" class="flex justify-center items-center">
        ...
        <button aria-label="open" id="open" onclick="showNav(true)" class="hidden focus:outline-none focus:ring-2">
            <svg class="" width="24" height="24" viewBox="0 0 24 24" fill="#374151"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M4 6H20" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M4 12H20" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M4 18H20" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </button>
        ...
        <button aria-label="close" id="close" onclick="showNav(true)" class=" focus:outline-none focus:ring-2">
            <svg class="" width="24" height="24" viewBox="0 0 24 24" fill="#374151"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M18 6L6 18" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="#374151"/>
                <path d="M6 6L18 18" stroke="#374151" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="#374151"/>
            </svg>
        </button>
    </div>
...
<div id="Main" class="fixed bottom-0 top-16 left-0 z-30 w-60 overflow-y-auto transition duration-300 transform translate-x-0 bg-dark">    
    <nav>       
		{{-- Dashboard button --}}
        <div class="mt-6 flex flex-col justify-start items-center pl-4 w-full border-gray-600 space-y-3 pb-5">
            <a href="{{ route('dashboard') }}" class="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none text-white focus:text-lightblue rounded @if (Route::currentRouteName() == 'dashboard') text-lightblue @endif ">
        ...
        <div class="flex flex-col justify-start items-center px-6 border-gray-600 w-full">
            <button onclick="showMenu1(true)"
                class="focus:outline-none focus:text-lightblue text-left  text-white flex justify-between items-center w-full py-2 space-x-14  ">
                <p class="text-base leading-5">Ventas</p>
                <svg id="icon1" class="transform rotate-180" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="menu1" class="hidden flex justify-start flex-col w-full md:w-auto items-start pb-1 ">
                <a href="{{ route('factura') }}" class="flex justify-start items-center space-x-6 hover:text-white focus:bg-orange focus:text-white hover:bg-orange text-gray-400 rounded px-3 py-2 w-full md:w-52 @if (Route::currentRouteName() == 'factura') text-lightblue @endif">
                    <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <p class="text-base leading-4">Facturas</p>
                </a>

                <button class="flex justify-start items-center space-x-6 hover:text-white focus:bg-orange focus:text-white hover:bg-orange text-gray-400 rounded px-3 py-2  w-full md:w-52">
        ...
        <div class="flex flex-col justify-start items-center px-6 border-gray-600 w-full  ">
            <button onclick="showMenu2(true)"
                class="focus:outline-none focus:text-lightblue  text-white flex justify-between items-center w-full py-2 space-x-14  ">
                <p class="text-base leading-5">Compras</p>
		...
		{{-- Menu 3 --}}
        <div class="flex flex-col justify-start items-center px-6 w-full space-y-32 ">
            <button onclick="showMenu3(true)"
                class="focus:outline-none focus:text-lightblue  text-white flex justify-between items-center w-full py-2 space-x-14  ">
                <p class="text-base leading-5">Administración</p>
            ...
            <div class="hidden flex justify-start flex-col items-start pb-5 ">
                <button class="flex justify-start items-center space-x-6 hover:text-white focus:bg-orange focus:text-white hover:bg-orange text-gray-400 rounded px-3 py-2  w-52">
                    <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
