<!-- component -->
<div class="fixed flex items-center justify-between w-60 transition duration-300 transform bg-white translate-x-0 px-4 py-3 border-gray-600">
    ...
    <div class="flex justify-between items-center space-x-3">
        ...
        <p class="text-xl leading-6 text-gray-700">iNvoice</p>
    </div>
...
<div id="Main" class="fixed bottom-0 top-16 left-0 z-30 w-60 overflow-y-auto transition duration-300 transform translate-x-0 bg-gray-700">    
    <nav>       
		{{-- Dashboard button --}}
        <div class="mt-6 flex flex-col justify-start items-center pl-4 w-full border-gray-600 space-y-3 pb-5">
            <button class="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none text-white focus:text-indigo-400 rounded @if (Route::currentRouteName() == 'dashboard') text-indigo-400 @endif ">
        ...
        <div class="flex flex-col justify-start items-center px-6 border-gray-600 w-full  ">
            <button onclick="showMenu1(true)"
                class="focus:outline-none focus:text-indigo-400 text-left  text-white flex justify-between items-center w-full py-2 space-x-14  ">
            ...
            <div id="menu1" class="hidden flex justify-start flex-col w-full md:w-auto items-start pb-1 ">
                <a href="{{ route('factura') }}" class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52 @if (Route::currentRouteName() == 'factura') text-indigo-400 @endif">
                    <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex flex-col justify-start items-center px-6 border-gray-600 w-full  ">
            <button onclick="showMenu2(true)"
                class="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-2 space-x-14  ">
